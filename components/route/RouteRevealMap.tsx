...
// Purely decorative — a few points along the selected curve to suggest
// "steps along the way" without spelling them out. Full step text lives in
// the Best Next Route card's "Route steps" list below, so the map itself
// stays an orientation moment, not a working document.
const MARKER_T = [0.32, 0.6, 0.86];
    ...
    <div className="shadow-card flex flex-col rounded-[26px] border border-line/70 bg-cream-card px-5 py-5">
      ...
      >
        ...
        >
          ...
          {/* subtle step markers along the selected route's path — decorative
              only, no text, so there's nothing for them to overlap. */}
